...
start_date = pd.Timestamp(datetime.datetime.now() + datetime.timedelta(days=-7), tz="Europe/Berlin")
...
energy_data = pd.concat([day_ahead_prices ,load, aggregate_water_reservoirs_and_hydro_storage], axis=1)
